...
<link href="/style/style.css?t=<?php echo filemtime(PATH . "/style/style.css")?>" rel="stylesheet" media="screen" />
...
<script src="/scripts/global.min.js?t=<?php echo filemtime(PATH . "/scripts/global.min.js")?>"></script>
<!--[if IE]>
